...
import {Card,RequestTypeAsset,ProfileIcon,AddButton,Name,MobileNumber,OriginDestination,FlexibleTimings,Date,MoreButton,
AssetType,From,To} from './styledComponents.js';
    ...
    render(){
        ...
        return (
            ...
            <Card>
                ...
                <AddButton type='button' onClick={()=>addButtonFunction(request.id)}>Add</AddButton>
            </Card>
