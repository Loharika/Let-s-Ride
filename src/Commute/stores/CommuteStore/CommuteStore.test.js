...
describe('Commute Store Tests', () => {
   ...
   it('should test  MyRide Requests  success state', async () => {
      ...
      expect(commuteStore.getMyRideRequestAPIError).toBe(null)
      expect(commuteStore.displayData.myRequests.rideRequests).toStrictEqual(rideRequestData.ride_requests)
      expect(commuteStore.displayData.myRequests.noOfRideRequests).toStrictEqual(
   ...
   it('should test  My Asset Requests  success state', async () => {
      ...
      expect(commuteStore.getMyAssetRequestAPIError).toBe(null)
      expect(commuteStore.displayData.myRequests.assetRequests).toEqual(assetRequestData.asset_requests)
      expect(commuteStore.displayData.myRequests.noOfAssetRequests).toBe(assetRequestData.total_asset_tansport_count)
   })
   ...
   it('should test  get Matching Ride Requests success state', async () => {
      ...
      expect(commuteStore.getMatchingRequestAPIError).toBe(null)
      expect(commuteStore.displayData.matchingResults.rideRequests).toEqual(matchedRideRequests.ride_requests)
      expect(commuteStore.displayData.matchingResults.noOfRideRequests).toEqual(matchedRideRequests.ride_requests_matches_count)
   ...
   it('should test  get Shared Ride success state', async () => {
      ...
      expect(commuteStore.getSharedRidesError).toBe(null)
      expect(commuteStore.displayData.sharedDetails.sharedRides).toEqual(rides.shared_rides)
      expect(commuteStore.displayData.sharedDetails.noOfSharedRides).toEqual(rides.count_of_ride_shares)
   ...
   it('should test  get Shared Ride success state', async () => {
      ...
      expect(commuteStore.getTravelInfoAPIError).toBe(null)
      expect(commuteStore.displayData.sharedDetails.travelInfo).toEqual(travelInfo.shared_travels)
      expect(commuteStore.displayData.sharedDetails.noOfSharedTravelInfo).toEqual(travelInfo.total_travel_infos_shared)
   });
   ...
   it("it should check setGetMatchingRequestAPIResponse",()=>{
      ...
      expect(commuteStore.displayData['matchingResults'].assetRequests).toEqual(data.asset_requests)
      expect(commuteStore.displayData['matchingResults'].noOfAssetRequests).toStrictEqual(data.assets_matches_count);
   ...
   it("it should check the onChangePageNumber ",()=>{
         ...
         expect(commuteStore.displayData['myRequests'].rideRequestPageNumber).toBe(4)
   });
   it("it should check the onChangePageNumber ",()=>{
         commuteStore.displayData['matchingResults'].requestType='ASSET';
         commuteStore.onChangePageNumber('matchingResults',4);
         expect(commuteStore.displayData['matchingResults'].assetRequestPageNumber).toBe(4)
   });
   it("it should check the onChangeSharedDetailsPageNumber ",()=>{
         ...
         expect(commuteStore.displayData['sharedDetails'].sharedTravelInfoPageNumber).toBe(4)
   });
   ...
   it("it should check the onChangeRequestType ",()=>{
    ...
    it("it should check the onChangeSharedDetailsPageNumber ",()=>{
         commuteStore.onChangeSharedDetailsPageNumber(4);
         expect(commuteStore.displayData['sharedDetails'].sharedRidePageNumber).toBe(4)
   });
    ...
    it("it should check the onChangeSharedDetailsShareType ",()=>{
         ...
         expect(commuteStore.displayData['sharedDetails'].shareType).toBe('travelInfo')
   });
})
