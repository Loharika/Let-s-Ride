...
class CommuteStore {
    ...
    getMyAssetRequests(dataToGetRequests){
        this.initMyRequestAPI();
        let assetRequestPromise=this.commuteService.myAssetRequestsAPI(dataToGetRequests);
        return bindPromiseWithOnSuccess(assetRequestPromise).
        to(this.setGetMyRequestAPIStatus,this.setGetMyRequestAPIResponse).
        catch(this.setGetMyRequestAPIError);
    }
    ...
    getMatchingRideRequests(dataToGetMatchingRequests){
        this.initMatchingRequestsAPI();
        let assetRequestPromise=this.commuteService.matchingRideRequestsAPI(dataToGetMatchingRequests);
        return bindPromiseWithOnSuccess(assetRequestPromise).
        to(this.setGetMatchingRequestAPIStatus,this.setGetMatchingRequestAPIResponse).
        catch(this.setGetMatchingRequestAPIError);
    }
    @action.bound
    getMatchingAssetRequests(dataToGetMatchingRequests){
        this.initMatchingRequestsAPI();
        let assetRequestPromise=this.commuteService.matchingAssetRequestsAPI(dataToGetMatchingRequests);
        return bindPromiseWithOnSuccess(assetRequestPromise).
        to(this.setGetMatchingRequestAPIStatus,this.setGetMatchingRequestAPIResponse).
        catch(this.setGetMatchingRequestAPIError);
    }
    ...
    getAllMatchingRequests(dataToGetMatchingRequests){
        this.initMatchingRequestsAPI();
        let assetRequestPromise=this.commuteService.matchingAllRequestsAPI(dataToGetMatchingRequests);
        return bindPromiseWithOnSuccess(assetRequestPromise).
        to(this.setGetMatchingRequestAPIStatus,this.setGetMatchingRequestAPIResponse).
        catch(this.setGetMatchingRequestAPIError);
    }
